    ...
    <footer className=" text-black bg-gradient-to-bl from-pink-300 via-red-200  to-purple-300" >
      ...
      <div className="max-w-screen-2xl mx-auto px-4 lg:py-12 py-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          {/* Connect Section */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-black">Connect Kidsworldbd.com</h3>
            {loading ? (
        ...
        <div className="max-w-screen-2xl mx-auto px-4 py-6">
          <div className="text-center">
            <p className="text-white text-sm">
              ©2025 Kidsworldbd. All rights reserved. Developed by <span className="text-white font-semibold hover:text-white transition-colors duration-300">Kidsworldbd</span>
            </p>
          </div>
        </div>
      </div>
