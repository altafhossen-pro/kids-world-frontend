...
const HeroBanner = () => {
    ...
    return (
      <section className="w-full mt-2 lg:mt-6 overflow-hidden">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative w-full rounded-2xl overflow-hidden aspect-[21/9] lg:aspect-[24/9] shadow-md bg-gray-200 animate-pulse">
          </div>
        </div>
      </section>
    );
  ...
  return (
    <section className="w-full mt-2 lg:mt-6 overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative w-full rounded-2xl overflow-hidden aspect-[21/9] lg:aspect-[24/9] shadow-md bg-gray-100">
          <Swiper
