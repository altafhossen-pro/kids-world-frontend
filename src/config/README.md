...
This directory contains the configuration system for the Kidsworldbd ecommerce website. It provides centralized management of site metadata, SEO settings, and page-specific information.
...
console.log(siteConfig.name); // "Kidsworldbd"
console.log(siteConfig.url); // "https://kidsworldbd.com"
console.log(siteConfig.contact.email); // "info@kidsworldbd.com"
```
...
pages: {
  // ... existing pages
  about: {
    title: "About Us - Kidsworldbd",
    description: "Learn more about Kidsworldbd and our jewelry business.",
  },
}
```
