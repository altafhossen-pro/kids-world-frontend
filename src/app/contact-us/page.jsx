...
export default function ContactUsPage() {
    ...
    const socialLinks = [
        {
            name: 'Facebook',
            url: 'https://facebook.com/kidsworldbd',
            icon: Facebook,
            color: 'bg-blue-600',
            followers: '25.2K',
        ...
        {
            name: 'Twitter',
            url: 'https://twitter.com/kidsworldbd',
            icon: Twitter,
            color: 'bg-blue-400',
            followers: '12.3K',
        ...
        {
            name: 'LinkedIn',
            url: 'https://linkedin.com/company/kidsworldbd',
            icon: Linkedin,
            color: 'bg-blue-700',
            followers: '8.9K',
        ...
        {
            name: 'YouTube',
            url: 'https://youtube.com/kidsworldbd',
            icon: Youtube,
            color: 'bg-red-600',
            followers: '15.6K',
        ...
        {
            name: 'GitHub',
            url: 'https://github.com/kidsworldbd',
            icon: Github,
            color: 'bg-gray-800',
            followers: '2.1K',
