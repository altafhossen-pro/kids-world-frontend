    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8 font-sans relative">
      <div className="max-w-md w-full bg-white rounded-3xl shadow-xl p-8 md:p-10 z-10 relative">
        ...
        <div className="min-h-[250px]">
          ...
          {/* Email Tab */}
          {activeTab === 'email' && (
            <form className="space-y-5 animate-in fade-in zoom-in-95 duration-200" onSubmit={(e) => e.preventDefault()}>
              <div>
              ...
              <button
                type="submit"
                className="w-full flex justify-center items-center py-4 px-4 mt-4 border border-transparent rounded-xl shadow-sm text-sm font-bold text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors gap-2"
              >
