  ...
  const sections = [
    {
      ...
      title: "Welcome",
      icon: FileText,
      content: `Welcome to Kidsworldbd.bd. By using our website, you agree to the following Terms & Conditions.`
    },
    {
      id: "general",
      title: "1. General",
      icon: FileText,
      content: `Kidsworldbd.bd reserves the right to update products, prices, offers, and these terms at any time without prior notice.`
    },
    {
...
• Product size may vary slightly due to manufacturing tolerance.`
    ...
    },
    {
      ...
      title: "4. Orders",
      icon: ShoppingCart,
      content: `Kidsworldbd.bd reserves the right to:
...
Incorrect information may result in delivery failure.`
    },
    {
      ...
      icon: FileText,
      content: `All logos, images, product descriptions, graphics, and website content belong to Kidsworldbd.bd and may not be copied without permission.`
    },
    {
      id: "limitation-liability",
      title: "8. Limitation of Liability",
      icon: AlertTriangle,
      content: `Kidsworldbd.bd shall not be responsible for indirect, incidental, or consequential damages arising from the use of the website or purchased products.`
    },
    {
      id: "governing-law",
