  ...
  const sections = [
    {
      ...
      icon: Shield,
      content: `Welcome to Kidsworldbd.bd. Your privacy is important to us. This Privacy Policy explains how we collect, use, and protect your personal information.`
    },
    {
...
• Send promotional offers (only if you agree)`
    },
    {
      ...
      icon: Lock,
      content: `Kidsworldbd.bd does not store your debit or credit card details. Online payments are processed securely through trusted payment gateway providers.`
    },
    {
      id: "cookies",
      title: "4. Cookies",
...
• Delete your account (subject to legal obligations)`
    },
    {
      ...
      icon: FileText,
      content: `Kidsworldbd.bd reserves the right to modify this Privacy Policy at any time. Updated versions will be published on this page.`
    },
    {
      id: "contact-us",
      title: "9. Contact Us",
      icon: Mail,
      content: `For any privacy-related questions, please contact us through our official Facebook page, email, or customer support number listed on Kidsworldbd.bd.`
    }
  ];
