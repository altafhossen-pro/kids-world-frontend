          ...
          <form onSubmit={handleSearch} className="flex gap-4">
            <div className="flex-1">
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-1 focus:ring-pink-500 focus:border-blue-500 focus:outline-none"
              />
            </div>
                      ...
                      <div className="flex justify-between items-center pb-4">
                        ...
                        <div className="flex items-center">
                          ...
                          <div>
                            ...
                            {step.completed && (
                              <p className={`text-sm mt-1 ${step.status === 'cancelled'
                                ? 'text-red-600'
