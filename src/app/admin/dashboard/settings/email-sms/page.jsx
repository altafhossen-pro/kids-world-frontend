            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 ml-11">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  disabled={!hasUpdatePermission}
                  placeholder="e.g. Kidsworldbd Store"
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500 disabled:bg-gray-100"
                />
              </div>
            </div>
            ...
            <form onSubmit={submitTestEmail} className="p-4">
              ...
              <div className="flex justify-end gap-3 mt-6">
                ...
                <button
                  ...
                  className={`
                    flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg font-medium transition-colors cursor-pointer
                    ${testingEmail || !testEmailAddress ? 'opacity-50 cursor-not-allowed' : 'hover:bg-blue-700'}
                  `}
                >
                  {testingEmail ? (
                    <>
            ...
            <form onSubmit={submitTestSms} className="p-4">
              ...
              <div className="flex justify-end gap-3 mt-6">
                ...
                <button
                  ...
                  className={`
                    flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg font-medium transition-colors cursor-pointer
                    ${testingSms || !testPhoneNumber ? 'opacity-50 cursor-not-allowed' : 'hover:bg-blue-700'}
                  `}
                >
                  {testingSms ? (
                    <>
